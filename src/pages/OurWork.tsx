...
const OurWork = () => {
  ...
  const imageUrls = [
    ...
    // Moblie app 
    "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=533&auto=format&fit=crop", // E-commerce 1
    "https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=800&h=533&auto=format&fit=crop", // E-commerce 2
    "https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=800&h=533&auto=format&fit=crop", // E-commerce 3
    "https://images.unsplash.com/photo-1546213290-e1b492ab3eee?w=800&h=533&auto=format&fit=crop", // E-commerce 4
    // Corporate
    ...
    "https://media-hosting.imagekit.io/8b84146d21f942da/WhatsApp%20Image%202025-05-05%20at%2017.27.22_c34e5a0f.jpg?Expires=1841054347&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=XrFDkMe29jWKxz~rGkwHHWFckFDbuIMVTb0FVhx2qvGdp6abz7gghPOpRS7vgAYb7~IAHTuAHnYfN5lBO--tzXTZDeHLxDqbz2dUMD39KK7jO~MqtHP2beap6Wbth9yCUpjBhm0irBjnMhC2PSihGaT3J3n7RM935o3d5taUvnPRHY1JjiLO~CMSKg5t-wkofp7tCdl4Q5bxQgmK72guFBraKFGJrx1fQ--i71tOy8O6BVe-XobHQOserllNC3FwgZPTJSwdcOZEFvQXWDunjVYKT4I0kPNxT0aUCupf-TzJzkMG3Wmv34AP22ZNr63T95yfyjDb78FtU~-IVkA1Eg__", // Corporate 2
    ...
    "https://media-hosting.imagekit.io/66eec9e5a4364fe1/WhatsApp%20Image%202025-05-05%20at%2017.27.29_217a67bc.jpg?Expires=1841054442&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=gbz4MAUu2X5jbvTDu04RPiVfojrbSiF~rP5gSRZDYYCTEhlzSpEWti~oIAYs4atacsZmkFdWKv3bn8nExTTIsBVida0aat6aovbLy5gr9yftaqtPAHVGaFP7jaxHURSec58MH8wKtIeVxVUzZKpF8ijGGsyY234aXubI~vEeL3GC0f-Du~jjEVLvpIUcFTutWTDfYIVXUHMmtDT3GvKhOqsvzSha8tuFaafkeB~LHIRCFd2OtxqfCFWScq6qTfajnv--N1ekZOb80Nd~L6zKLGOSJG1S55sstRkKIbef~LneUcEq~few3J8XOgmoeo-uIalq3XeuWMu25rHJhlhPxg__", // Corporate 4
    // Healthcare
    ...
    "https://images.unsplash.com/photo-1554177255-61502b352de3?w=800&h=533&auto=format&fit=crop", // Social 4
  ];
  ...
  const projects = Array(40).fill(null).map((_, i) => {
    ...
    const types = ["Mobile App", "Website", "Web Application", "Dashboard"];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <p className="text-zinc-500">
              ...
              {selectedCategory !== "All Work" && ` in ${selectedCategory}`}
            </p>
          </div>
